...
Para correr el codigo es necesario:
	-Archivos:
		...
		-> main.c : Código en donde se define la función main en la cual se utilizarán las funciones de los archivos 
			   genetico.h y fun.h. El archivo debe comenzar con:
